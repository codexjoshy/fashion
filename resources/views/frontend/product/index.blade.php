                    ...
                    <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
                                    <div class="tg-product">
                                        ...
                                        <figure class="tg-productimg">
                                            <a
                                                href="{{ route('frontend.product.show', [$category->slug, $item->slug]) }}">
                                                <img src="{{ Storage::url($item->image) }}" alt="image description"></a>
                                            {{-- <figcaption>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <nav class="tg-pagination">
                                ...
                                {{ $galleries->links('pagination.paginate') }}
                            </nav>
                        </div>
                    </div>
                </div>
                    ...
                    <form class="tg-themeform tg-formrefinesearch">
                        <fieldset>
                            <div class="tg-widget tg-themeformsearch">
                                <input type="search" class="form-control" name="searchhere" placeholder="Search Here">
